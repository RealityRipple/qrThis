var qrthis_popup = {
 init: function()
 {
  ...
  let t = document.getElementById('qrThisBox');
  t.innerHTML = '';
  let d = 256;
  try
  {
   let qrPub = new QRCode(t,
                          {
                           text: s,
                           width: d,
                           height: d,
...
! function() {
	...
	var l = [
		...
		q = p ? o : m() ? function() {
			...
			var e = function(a, b) {
				this._bIsPainted = !1, this._htOption = b, this._elCanvas = document.createElementNS("http://www.w3.org/1999/xhtml", "canvas"), this._elCanvas.width = b.width, this._elCanvas.height = b.height, a.appendChild(this._elCanvas), this._el = a, this._oContext = this._elCanvas.getContext("2d"), this._bIsPainted = !1, this._elImage = document.createElement("image"), this._elImage.style.display = "none", this._el.appendChild(this._elImage), this._bSupportDataURI = null
			};
...
window.addEventListener('deactivate', window.close, false);
